					...
					<div class="container">
						<form class="registerForm" method="post" action="">
							...
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="name" class="form-control" name="name" value="<?php echo isset($_POST['name']) ? $_POST['name'] : '' ?>" placeholder="Jan" required>
								</div>
							</div>
							<!-- Lastname -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="lastname" class="form-control" name="lastname" value="<?php echo isset($_POST['lastname']) ? $_POST['lastname'] : '' ?>" placeholder="Harris" required>
								</div>
							</div>
							<!-- BirthDate -->
							<div class="row form-group">
							...
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="address" class="form-control" name="address" value="<?php echo isset($_POST['address']) ? $_POST['address'] : '' ?>" placeholder="willemStraat 45" required>
								</div>
							</div>
							<!-- Postcode -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="zipcode" class="form-control" name="zipcode" value="<?php echo isset($_POST['zipcode']) ? $_POST['zipcode'] : '' ?>" placeholder="7007HS" required>
								</div>
							</div>
							<!-- City -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="city" class="form-control" name="city" value="<?php echo isset($_POST['city']) ? $_POST['city'] : '' ?>" placeholder="Doesburg" required>
								</div>
							</div>
							<!-- Country -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="country" class="form-control" name="country" value="<?php echo isset($_POST['country']) ? $_POST['country'] : '' ?>" placeholder="Nederland" required>
								</div>
							</div>
							<!-- Phonenumber -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="telnr" class="form-control" name="telnr" value="<?php echo isset($_POST['telnr']) ? $_POST['telnr'] : '' ?>" placeholder="0612344455" required>
								</div>
							</div>
							<!-- Phonenumber 2 -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="telnr2" class="form-control" name="telnr2" value="<?php echo isset($_POST['telnr2']) ? $_POST['telnr2'] : '' ?>" placeholder="0314364999">
								</div>
							</div>
							<!-- KVK number -->
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="kvkNummer" class="form-control" name="kvkNummer" value="<?php echo isset($_POST['kvkNummer']) ? $_POST['kvkNummer'] : '' ?>" placeholder="12345678" required>
									<div class="redText">
					          <?php
					          if ($errorData) {
							...
							<div class="row form-group">
								...
								<div class="col-lg-8">
									<input type="text" id="securityA" class="form-control" name="securityA" required>
								</div>
							</div>
